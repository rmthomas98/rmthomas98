        ...
        <div className="projects-container">
          <div className="project">
            ...
            <div className="project-buttons">
              <a href="https://github.com/rmthomas98/rmthomas98/tree/master/nasa" target="_blank">View Code</a>
              <a href="https://space-station.netlify.app/" target="_blank">Visit Site</a>
            </div>
          </div>
          <div className="project">
            ...
            <div className="project-buttons">
              <a href="https://github.com/rmthomas98/rmthomas98/tree/master/coffee" target="_blank">View Code</a>
              <a href="https://rmthomas98.github.io/" target="_blank">Visit Site</a>
            </div>
          </div>
          <div className="project">
            ...
            <div className="project-buttons">
              <a href="https://github.com/rmthomas98/rmthomas98/tree/master/weather-react" target="_blank">View Code</a>
              <a href="https://youthful-babbage-f24b3c.netlify.app/" target="_blank">Visit Site</a>
            </div>
          </div>
        </div>
      </div>
